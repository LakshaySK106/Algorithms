// Problem Statement -> Given a set of n integers, divide the set in two subsets of n/2 sizes each such that the absolute 
// difference of the sum of two subsets is as minimum as possible. If n is even, then sizes of two subsets must be strictly n/2
